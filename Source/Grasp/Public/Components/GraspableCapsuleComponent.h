...
#endif
#include "GraspableCapsuleComponent.generated.h"
...
class GRASP_API UGraspableCapsuleComponent : public UCapsuleComponent, public IGraspableComponent
{
	GENERATED_BODY()
...
public:
	UGraspableCapsuleComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get())
