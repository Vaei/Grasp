...
class GRASP_API UGraspableSphereComponent : public USphereComponent, public IGraspableComponent
{
	GENERATED_BODY()
...
public:
	UGraspableSphereComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get())
